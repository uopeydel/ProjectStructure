...
{
    public static class TrapMiddlewareExtensions
    {
        public static IApplicationBuilder UseTrapMiddleware(this IApplicationBuilder builder)
        {
            if (builder == null)
            {
            ...
            return builder.UseMiddleware<TrapMiddleware>();
        }
    }


    public class TrapMiddleware
    {
        ...
        public TrapMiddleware(RequestDelegate next)
        {
            _next = next;
        }
